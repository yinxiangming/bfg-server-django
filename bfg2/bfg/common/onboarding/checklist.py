...
class Item:
    #: Label the thing, never its state. "Contact email", not "Contact email
    #: set" — the row renders the same text whether or not it is done, so a
    #: past-tense label asserts on an empty row exactly what it asserts on a
    #: filled one, and an unconfigured shop reads as a configured one. The icon
    #: and the value carry the state.
    key: str
    label: str
    label_zh: str
    href: str
...
STEPS: List[Step] = [
    Step(
        ...
        icon='tabler-world',
        items=[
            Item('basics.country', 'Country', '国家 / 地区', GENERAL_LOCALE,
            ...
            Item('basics.currency', 'Currency', '货币', GENERAL_LOCALE,
            ...
            Item('basics.currency_row', 'Currency record in finance', '财务中的货币记录',
            ...
            Item('basics.language', 'Default language', '默认语言', GENERAL_LOCALE,
            ...
            Item('basics.timezone', 'Timezone', '时区', GENERAL_LOCALE,
            ...
            Item('basics.site_name', 'Shop name', '店铺名称', GENERAL_STOREFRONT,
    ...
    Step(
        ...
        items=[
            ...
            Item('brand.contact_phone', 'Contact phone', '联系电话', GENERAL_STOREFRONT,
    ...
    Step(
        ...
        items=[
            Item('catalogue.store', 'Active store', '启用中的店铺', '/admin/store/stores',
            ...
            Item('catalogue.category', 'Product categories', '商品分类', '/admin/store/categories',
            ...
            Item('catalogue.product', 'Products for sale', '在售商品', '/admin/store/products',
    ...
    Step(
        ...
        items=[
            Item('payments.gateway', 'Payment method', '支付方式',
            ...
            Item('payments.tax_rate', 'Tax rate', '税率', f'{SETTINGS_FINANCE}?tab=tax',
            ...
            Item('payments.invoice_prefix', 'Invoice numbering', '发票编号规则',
    ...
    Step(
        ...
        icon='tabler-truck',
        items=[
            Item('delivery.warehouse', 'Warehouse', '仓库', f'{SETTINGS_DELIVERY}?tab=warehouses',
            ...
            Item('delivery.warehouse_address', 'Warehouse address', '仓库地址',
            ...
            Item('delivery.carrier', 'Carrier', '承运商', f'{SETTINGS_DELIVERY}?tab=carriers',
            ...
            Item('delivery.zone', 'Delivery zone', '配送区域', f'{SETTINGS_DELIVERY}?tab=zones',
                 lambda f: f.has_zone, from_template=True,
                 value=lambda f: f.names(f.zone_names)),
            Item('delivery.freight', 'Free-shipping threshold', '包邮门槛',
    ...
    Step(
        ...
        items=[
            ...
            Item('content.site', 'Storefront site', '站点', f'{SETTINGS_WEB}?tab=sites',
                 ...
                 hint_zh='绑定域名后会自动创建。'),
            Item('content.home', 'Home page', '首页', f'{SETTINGS_WEB}?tab=pages',
            ...
            Item('content.about', 'About page', '关于我们', f'{SETTINGS_WEB}?tab=pages',
                 _has_page('about'), required=False, from_template=True, value=_page_value('about')),
            Item('content.contact', 'Contact page', '联系我们', f'{SETTINGS_WEB}?tab=pages',
                 _has_page('contact'), from_template=True, value=_page_value('contact')),
            Item('content.privacy', 'Privacy policy', '隐私政策', f'{SETTINGS_WEB}?tab=pages',
            ...
            Item('content.terms', 'Terms of service', '服务条款', f'{SETTINGS_WEB}?tab=pages',
                 _has_page('terms'), from_template=True, value=_page_value('terms')),
            Item('content.returns', 'Returns policy', '退换货政策', f'{SETTINGS_WEB}?tab=pages',
                 _has_page('returns'), from_template=True, value=_page_value('returns')),
            Item('content.delivery', 'Delivery policy', '配送说明', f'{SETTINGS_WEB}?tab=pages',
                 _has_page('delivery'), from_template=True, value=_page_value('delivery')),
            Item('content.menu_header', 'Header navigation', '顶部导航', f'{SETTINGS_WEB}?tab=menus',
            ...
            Item('content.menu_footer', 'Footer navigation', '页脚导航', f'{SETTINGS_WEB}?tab=menus',
    ...
    Step(
        ...
        icon='tabler-rocket',
        items=[
            Item('launch.email_config', 'Outgoing email', '发信服务',
            ...
            Item('launch.domain', 'Custom domain', '自有域名', f'{SETTINGS_WEB}?tab=sites',
            ...
            Item('launch.staff', 'Team members', '团队成员', f'{SETTINGS_GENERAL}?tab=users',
            ...
            Item('launch.analytics', 'Analytics', '统计分析',
                 GENERAL_STOREFRONT,
