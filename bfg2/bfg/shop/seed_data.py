...
def create_product_categories(workspace, stdout=None, style=None):
    ...
    categories_data = [
        ...
        {'name': 'Clothes', 'slug': 'clothes', 'parent_slug': None, 'order': 1, 'icon': 'tabler-shirt', 'description': 'Clothing and apparel for all', 'image_path': 'modules/cp_categorylist/views/img/3-cp_categorylist.jpg'},
        {'name': 'Bag', 'slug': 'bag', 'parent_slug': None, 'order': 2, 'icon': 'tabler-briefcase', 'description': 'Bags and luggage', 'image_path': 'modules/cp_categorylist/views/img/6-cp_categorylist.jpg'},
        {'name': 'Shoes', 'slug': 'shoes', 'parent_slug': None, 'order': 3, 'icon': 'tabler-shoe', 'description': 'Footwear for all occasions', 'image_path': 'modules/cp_categorylist/views/img/9-cp_categorylist.jpg'},
        {'name': 'Shorts', 'slug': 'shorts', 'parent_slug': None, 'order': 4, 'icon': 'tabler-shirt', 'description': 'Shorts and casual wear', 'image_path': 'modules/cp_categorylist/views/img/10-cp_categorylist.jpg'},
        {'name': 'Cap', 'slug': 'cap', 'parent_slug': None, 'order': 5, 'icon': 'tabler-hat', 'description': 'Caps and hats', 'image_path': 'modules/cp_categorylist/views/img/11-cp_categorylist.jpg'},
        {'name': 'Watch', 'slug': 'watch', 'parent_slug': None, 'order': 6, 'icon': 'tabler-clock', 'description': 'Watches and timepieces', 'image_path': 'modules/cp_categorylist/views/img/12-cp_categorylist.jpg'},
        {'name': 'Belt', 'slug': 'belt', 'parent_slug': None, 'order': 7, 'icon': 'tabler-belt', 'description': 'Belts and accessories', 'image_path': 'modules/cp_categorylist/views/img/13-cp_categorylist.jpg'},
        {'name': 'Gogals', 'slug': 'gogals', 'parent_slug': None, 'order': 8, 'icon': 'tabler-sunglasses', 'description': 'Sunglasses and eyewear', 'image_path': 'modules/cp_categorylist/views/img/14-cp_categorylist.jpg'},
    ...
    products_data = [
        {
            ...
            'category_slug': 'shoes',
            'image_paths': ['25-home_default/nike-men-s-air-force-1.jpg'],
        ...
        },
        {
            ...
            'category_slug': 'watch',
            'image_paths': ['125-home_default/daniel-wellington-oxford-watch.jpg', '126-home_default/daniel-wellington-oxford-watch.jpg'],
        ...
        },
        {
            ...
            'category_slug': 'bag',
            'image_paths': ['129-home_default/boundaries-women-s-tote-bag.jpg'],
        ...
        },
        {
            ...
            'image_paths': ['135-home_default/jeans-shorts-women-s-summer.jpg'],
            'tags': ['new-arrival'] if tags else [],
            'is_featured': True,
            'track_inventory': True,
        },
        {
            ...
            'category_slug': 'bag',
            'image_paths': ['138-home_default/buckner-leather-backpack.jpg'],
        ...
        },
        {
            ...
            'category_slug': 'cap',
            'image_paths': ['142-home_default/classic-men-s-warm-winter-cap.jpg'],
            'tags': ['new-arrival'] if tags else [],
            'is_featured': True,
            'track_inventory': True,
        },
        {
            ...
            'image_paths': ['144-home_default/specs-the-prince-sunglasses.jpg'],
            'tags': ['sale', 'featured'] if tags else [],
            'is_featured': True,
            'track_inventory': True,
        },
        {
            ...
            'category_slug': 'belt',
            'image_paths': ['148-home_default/women-s-black-color-buckle-solid.jpg'],
            'tags': ['featured'] if tags else [],
            'is_featured': True,
            'track_inventory': True,
        },
        {
            ...
            'image_paths': ['155-home_default/natural-uniforms-women-s-t-shirt.jpg'],
            'tags': ['new-arrival'] if tags else [],
            'is_featured': False,
            'track_inventory': True,
        },
        {
            ...
            'category_slug': 'shoes',
            'image_paths': ['163-home_default/hush-puppies-sarah-trim-buckle.jpg'],
            'tags': ['featured'] if tags else [],
            'is_featured': False,
            'track_inventory': True,
        },
        {
            ...
            'category_slug': 'clothes',
            'image_paths': ['167-home_default/tartine-et-chocolat-cardigan-beige.jpg'],
            'tags': ['new-arrival', 'featured'] if tags else [],
            'is_featured': True,
            'track_inventory': True,
        },
        {
            ...
            'category_slug': 'watch',
            'image_paths': ['171-home_default/mvmt-boulevard-beverly-watch.jpg'],
            'tags': ['sale', 'featured'] if tags else [],
            'is_featured': True,
            'track_inventory': True,
        },
        {
            ...
            'category_slug': 'clothes',
            'image_paths': ['176-home_default/lauren-packable-down-puffer-jacket.jpg'],
            'tags': ['new-arrival'] if tags else [],
            'is_featured': True,
            'track_inventory': True,
        },
        {
            ...
            'category_slug': 'shoes',
            'image_paths': ['179-home_default/time-and-tru-women-s-lug-sole.jpg'],
        ...
        },
        {
            ...
            'category_slug': 'belt',
            'image_paths': ['183-home_default/black-women-solid-casual-belt.jpg'],
            'tags': ['featured'] if tags else [],
            'is_featured': False,
            'track_inventory': True,
        },
        {
            ...
            'category_slug': 'clothes',
            'image_paths': ['186-home_default/tru-brushed-herringbone-shacket.jpg'],
            'tags': ['sale', 'featured'] if tags else [],
            'is_featured': True,
            'track_inventory': True,
        },
        {
            ...
            'category_slug': 'shoes',
            'image_paths': ['196-home_default/platform-with-zipper-sneaker.jpg'],
            'tags': ['new-arrival'] if tags else [],
            'is_featured': True,
            'track_inventory': True,
        },
        {
            ...
            'category_slug': 'clothes',
            'image_paths': ['200-home_default/nation-girls-fashion-flare-jeggings.jpg'],
            'tags': ['sale'] if tags else [],
            'is_featured': True,
            'track_inventory': True,
        },
        {
            ...
            'category_slug': 'clothes',
            'image_paths': ['203-home_default/women-short-sleeve-silk-t-shirt.jpg'],
            'tags': ['new-arrival', 'featured'] if tags else [],
            'is_featured': True,
            'track_inventory': True,
        },
        {
            ...
            'category_slug': 'clothes',
            'image_paths': ['208-home_default/men-s-corduroy-vintage-polo-shirts.jpg'],
            'tags': ['sale', 'featured'] if tags else [],
            'is_featured': True,
            'track_inventory': True,
        },
...
def create_product_media(workspace, products, stdout=None, style=None):
    ...
    - image_path comes from product._image_paths (e.g. '25-home_default/nike-men-s-air-force-1.jpg').
    - You must place these files under server media/seed_images/store/ (e.g. copy from a
      reference project or run a script that populates seed_images/store with the expected
      subdirs and filenames). manage.py seed_data --copy-images copies to seed_images/avatars
      and seed_images/products from vuexy; product seed expects seed_images/store/ structure.
