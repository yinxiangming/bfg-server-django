...
STEPS: List[Step] = [
    ...
    Step(
        ...
        title_zh='品牌与联系方式',
        description='What customers see in the header, the footer and in your emails.',
        description_zh='买家在页头、页脚与邮件里看到的信息。',
        icon='tabler-palette',
        items=[
            ...
            Item('brand.email_config', 'Outgoing email configured', '已配置发信服务', f'{SETTINGS_GENERAL}?tab=email',
