# BFG in-repo documentation

English reference material for agents and developers working on the Django **BFG** package inside the server tree (`bfg2/bfg/`).
...
Long-form deployment narratives also live in the separate **`bfg-docs`** repository (e.g. `deployment/11-embedded-platform-single-vps.md`).
