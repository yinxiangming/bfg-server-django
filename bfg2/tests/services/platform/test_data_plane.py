...
def test_data_export_endpoint_is_superuser_only_and_separate_from_config_export(tmp_path, settings):
    ...
    path = f"/api/v1/platform/console/workspaces/{owner.pk}/data-export/"
    ...
    assert client.get(f"/api/v1/platform/console/workspaces/{owner.pk}/data-snapshots/").status_code == 200

    verify_response = client.post(
        f"/api/v1/platform/console/workspaces/{owner.pk}/data-verify/",
    ...
    restore_response = client.post(
        "/api/v1/platform/console/workspaces/data-restore/",
        {
            "confirm": True,
    ...
    config_response = client.post(
        f"/api/v1/platform/console/workspaces/{owner.pk}/export/",
